...
SRC_URI="mirror://sourceforge/${PN%-data}/${PN%-data}-0.24-universal.zip
mirror://sourceforge/${PN%-data}/unvanquished_0.24.1.pk3"
...
src_install() {
	...
	doins -r pkg/* "${DISTDIR}"/unvanquished_0.24.1.pk3
	prepgamesdirs
}
