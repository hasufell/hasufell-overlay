...
SRC_URI="mirror://sourceforge/${PN%-data}/${MY_PN}_0.5.1.zip -> ${PN}-0.5.1.zip
	mirror://sourceforge/${PN%-data}/vms-0.10.0.pk3
...
src_install() {
	...
	doins "${DISTDIR}"/{vms-0.10.0,map-plat23-b6,map-parpax-b03,map-parpax-b03h,map-thunder-b1,map-plat23-b7,map-parpax-b04,map-yocto-a916}.pk3
