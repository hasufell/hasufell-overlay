...
SRC_URI="mirror://sourceforge/${PN%-data}/${MY_PN}_0.5.1.zip -> ${PN}-0.5.1.zip
	...
	mirror://sourceforge/${PN%-data}/map-yocto-b1a.pk3
	mirror://sourceforge/${PN%-data}/map-plat23-b9.pk3
	mirror://sourceforge/${PN%-data}/map-parpax-d01.pk3
	mirror://sourceforge/${PN%-data}/map-thunder-b1a.pk3
	mirror://sourceforge/${PN%-data}/map-parpax-d02.pk3
	mirror://sourceforge/${PN%-data}/map-thunder-b2.pk3
	...
	mirror://sourceforge/${PN%-data}/pakC.pk3 -> unv-pakC.pk3
	mirror://sourceforge/${PN%-data}/pakD.pk3 -> unv-pakD.pk3
	mirror://sourceforge/${PN%-data}/pakE.pk3 -> unv-pakE.pk3
	mirror://sourceforge/${PN%-data}/pakF.pk3 -> unv-pakF.pk3"
...
src_install() {
	...
	rm -f "${D}${GAMES_DATADIR}"/${PN%-data}/main/vms-0.5.1.pk3
