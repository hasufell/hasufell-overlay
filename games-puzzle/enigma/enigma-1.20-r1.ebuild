...
src_prepare() {
	epatch "${FILESDIR}"/0001-Add-configure-switch-to-optionally-use-system-enet.patch \
		"${FILESDIR}"/0002-Allow-building-against-enet-1.3.patch \
		"${FILESDIR}"/0003-Respect-CXXFLAGS.patch \
